...
The example application is a social blogging site (i.e. a Medium.com clone) called "Learning". It uses a custom API for all requests, including authentication. You can view a live demo over at https://demo.realworld.build
